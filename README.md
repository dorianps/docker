...
Docker is faster than Windows Linux Subsystem. See the [quick test](https://github.com/dorianps/docker/wiki/Windows:-Docker-vs.-WSL-speed-test) performed on the same computer under the same conditions.
